 ...
 * Class MassDelete
 */
class MassNotMarried extends \Magento\Backend\App\Action implements HttpPostActionInterface
{
    /**
    ...
    public function execute()
    {
       ...
       foreach($ids as $v){
        ...
        $student->load($v)->setData('isMarried', 0)->save();
       }

       $this->messageManager->addSuccessMessage(__('Have been saved.'));
